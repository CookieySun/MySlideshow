package com.example.sunsh.myslideshow
...
//            imageSwicher.setInAnimation(this, android.R.anim.fade_out)
            movePosition(-1)
        }
        nextButton.setOnClickListener {
            imageSwicher.setInAnimation(this, android.R.anim.slide_in_left)
//            imageSwicher.setInAnimation(this, android.R.anim.slide_out_right)
            movePosition(1)
        }
        ...
        slideshowButtom.setOnClickListener {
